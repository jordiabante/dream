...
########################################################### parameter range
eps_range <- c(0.001,0.005,0.01,0.05,0.1,1)
lambda_range <-  c(0.01,0.1,0.2,0.5,0.8,1,2)
C_range <- c(10,20,30,40,50,60,70,100,150,200)
nu_range <- c(0.4,0.5,0.6,0.7,0.8,0.9)
