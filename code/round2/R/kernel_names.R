...
genex_dot_product <- c('../../data/round2/kernels/dot_product_genex_original',
                           '../../data/round2/kernels/dot_product_genex_original',NA)

cnv_angular_similarity <- c('../../data/round2/kernels/angular_similarity_mutations_driver',NA,NA)
...
write.table(kernel_names,"kernel_names.txt",sep="\t",row.names = F,col.names = T,quote = F)