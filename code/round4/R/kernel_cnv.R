...
write.table(cor_matdf,file='../../data/round4/kernels/corr_cnv.txt',col.names=F,row.names=F,sep="\t",quote=F)
...
write.table(dotprod_kerneldf,file='../../data/round4/kernels/dot_product_cnv.txt',col.names=F,row.names=F,sep="\t",quote=F)
...
write.table(rbf_kerneldf,file='../../data/round4/kernels/rbf_cnv.txt',col.names=F,row.names=F,sep="\t",quote=F)
...
write.table(angular_kerneldf,file='../../data/round4/kernels/angular_similarity_cnv.txt',col.names=F,row.names=F,sep="\t",quote=F)

cn_featuredf = as.data.frame(cn_features,col.names=F,row.names=F,sep="	",quote=F)
write.table(cn_featuredf,file='../../data/round4/features/cnv_feature.txt',col.names=F,row.names=F,sep="\t",quote=F)
