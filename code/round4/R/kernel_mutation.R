...
################################################# saving files ###################################  
  write.table(kernel_all_genes_dot,file="../../data/round4/kernels/dot_product_mutations_original.txt",
              sep="\t",quote=F,col.names=F,row.names=F)
  
  write.table(kernel_all_genes_angular,file="../../data/round4/kernels/angular_similarity_mutations_original.txt",
              sep="\t",quote=F,col.names=F,row.names=F)
 
  write.table(kernel_driver_genes_dot,file="../../data/round4/kernels/dot_product_mutations_driver.txt",
              sep="\t",quote=F,col.names=F,row.names=F)
  
  write.table(kernel_driver_genes_angular,file="../../data/round4/kernels/angular_similarity_mutations_driver.txt",
              sep="\t",quote=F,col.names=F,row.names=F)
 
  write.table(kernel_nonsilent_dot,file="../../data/round4/kernels/dot_product_mutations_nonsilent.txt",
              sep="\t",quote=F,col.names=F,row.names=F)
  
  write.table(kernel_nonsilent_angular,file="../../data/round4/kernels/angular_similarity_mutations_nonsilent.txt",
              sep="\t",quote=F,col.names=F,row.names=F)
 
  
  write.table(kernel_all_genes_corr,file="../../data/round4/kernels/corr_mutations_original.txt",
              sep="\t",quote=F,col.names=F,row.names=F)
  
  write.table(kernel_driver_genes_corr,file="../../data/round4/kernels/corr_mutations_driver.txt",
              sep="\t",quote=F,col.names=F,row.names=F)
 
  write.table(kernel_nonsilent_corr,file="../../data/round4/kernels/corr_mutations_nonsilent.txt",
              sep="\t",quote=F,col.names=F,row.names=F)

  write.table(kernel_all_genes_rbf,file="../../data/round4/kernels/rbf_mutations_original.txt",
              sep="\t",quote=F,col.names=F,row.names=F)
  
  write.table(kernel_driver_genes_rbf,file="../../data/round4/kernels/rbf_mutations_driver.txt",
              sep="\t",quote=F,col.names=F,row.names=F)
 
  write.table(kernel_nonsilent_rbf,file="../../data/round4/kernels/rbf_mutations_nonsilent.txt",
              sep="\t",quote=F,col.names=F,row.names=F)

 write.table(feature_all_genes,file="../../data/round4/features/mutation_features_original.txt",
              sep="\t",quote=F,col.names=F,row.names=F)
 write.table(feature_driver_genes,file="../../data/round4/features/mutation_features_driver.txt",
              sep="\t",quote=F,col.names=F,row.names=F)
  
 write.table(feature_nonsilent,file="../../data/round4/features/mutation_features_nonsilent.txt",
              sep="\t",quote=F,col.names=F,row.names=F)
