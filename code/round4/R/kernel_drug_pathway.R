...
## write files
write.table(drug_score,file="../../data/round4/features/drug_pathway.txt",col.names=F,row.names=F,sep="\t",quote=F)


cor_matdf = as.data.frame(round(cor_mat, 4))
write.table(cor_matdf,file='../../data/round4/kernels/corr_drug_pathway.txt',col.names=F,row.names=F,sep="\t",quote=F)

dotprod_kerneldf = as.data.frame(round(dotprod_kernel, 4))
write.table(dotprod_kerneldf,file='../../data/round4/kernels/dot_product_drug_pathway.txt',col.names=F,row.names=F,sep="\t",quote=F)

angular_kerneldf = as.data.frame(round(angular_kernel, 4))
write.table(angular_kerneldf,file='../../data/round4/kernels/angular_similarity_drug_pathway.txt',col.names=F,row.names=F,sep="\t",quote=F)

rbf_kerneldf = as.data.frame(round(rbf_kernel, 4))
write.table(rbf_kerneldf,file='../../data/round4/kernels/rbf_drug_pathway.txt',col.names=F,row.names=F,sep="\t",quote=F)
